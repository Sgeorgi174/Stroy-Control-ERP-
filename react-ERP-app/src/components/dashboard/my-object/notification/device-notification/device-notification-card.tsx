...
type DeviceNotificationCardProps = {
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <CardDescription className="text-sm text-muted-foreground mt-1">
              <span>{deviceTransfer.device.name}, в пути на ваш объект</span>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col gap-2 mt-5">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span>{deviceTransfer.fromObject.name}</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2 mt-5">
                  <div className="flex items-center gap-1">
                    <User className="w-4 h-4" />
                    <span>
                      {deviceTransfer.toObject.foreman?.lastName}{" "}
                      {deviceTransfer.toObject.foreman?.firstName}
                    </span>
                  </div>
                  <div className="flex items-center gap-1">
                    <MapPin className="w-4 h-4" />
                    <span>{deviceTransfer.toObject.name}</span>
                  </div>
                </div>
              </div>
            </CardDescription>
